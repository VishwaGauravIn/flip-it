...
export default function Home() {
  ...
  return (
    <>
      ...
      <CoinFlip/>
      <div className="flex items-center justify-center relative py-4 dark:text-gray-200"><a href="https://github.com/VishwaGauravIn" target="_blank" rel="noreferrer" className="opacity-60 hover:opacity-95 dark:text-red-400">{'</>'} with 💛 by Vishwa Gaurav</a></div>
    </>
  );
}
